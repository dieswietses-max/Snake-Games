...
let score = localStorage.getItem('snakeWinsGreen') ? parseInt(localStorage.getItem('snakeWinsGreen')) : 0;
let scoreRed = localStorage.getItem('snakeWinsRed') ? parseInt(localStorage.getItem('snakeWinsRed')) : 0;
...
function resetGame(clearScores = false) {
    ...
    if (clearScores) {
        highScore = 0;
        localStorage.setItem('snakeWinsGreen', '0');
        localStorage.setItem('snakeWinsRed', '0');
...
function endGame(winner = '') {
    ...
    if (winner === 'Green') {
        score += 1;
        localStorage.setItem('snakeWinsGreen', score);
    } else if (winner === 'Red') {
        scoreRed += 1;
        localStorage.setItem('snakeWinsRed', scoreRed);
    }
