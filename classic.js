...
let lastFoodSpawn = 0;
let pendingGrowth = 0;
let score = localStorage.getItem('classicSnakeScore') ? parseInt(localStorage.getItem('classicSnakeScore')) : 0;
let highScore = localStorage.getItem('classicSnakeHigh') ? parseInt(localStorage.getItem('classicSnakeHigh')) : 0;
...
function resetGame(clearScores = false) {
    ...
    if (clearScores) {
        highScore = 0;
        localStorage.setItem('classicSnakeScore', '0');
        localStorage.setItem('classicSnakeHigh', '0');
    }
...
function endGame() {
    ...
    if (score > highScore) {
        highScore = score;
        localStorage.setItem('classicSnakeHigh', highScore);
        highScoreDisplay.textContent = highScore;
    }
    localStorage.setItem('classicSnakeScore', score);
