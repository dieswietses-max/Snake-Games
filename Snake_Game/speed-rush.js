...
let lastFoodSpawn = 0;
let pendingGrowth = 0;
let score = localStorage.getItem('speedRushScore') ? parseInt(localStorage.getItem('speedRushScore')) : 0;
let highScore = localStorage.getItem('speedRushHigh') ? parseInt(localStorage.getItem('speedRushHigh')) : 0;
...
speedLevelDisplay.textContent = '1.0';
...
function resetGame(clearScores = false) {
    ...
    if (clearScores) {
        highScore = 0;
        localStorage.setItem('speedRushScore', '0');
        localStorage.setItem('speedRushHigh', '0');
    }
...
function update() {
    ...
    if (foodIdx !== -1) {
        ...
        const speedMultiplier = (1.0 + (score / 100)).toFixed(1);
        speedLevelDisplay.textContent = speedMultiplier;
        scoreDisplay.textContent = score;
    }
...
function endGame() {
    ...
    if (score > highScore) {
        highScore = score;
        localStorage.setItem('speedRushHigh', highScore);
        highScoreDisplay.textContent = highScore;
    }
    localStorage.setItem('speedRushScore', score);
